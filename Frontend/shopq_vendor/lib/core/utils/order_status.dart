...
/// Canonical order-status model — IDENTICAL across the user, admin and vendor
/// apps and matching the backend (OrderStatusService). Sub-order statuses and
/// parent derived statuses both map here so the tracking step, label and colour
/// are the same everywhere.
///
/// Sub-order flow : pending → confirmed → packed → assigned → out_for_delivery → delivered (+ cancelled)
...
class OrderStatus {
  /// Customer tracking step: 0 placed · 1 packed · 2 on the way · 3 delivered.
