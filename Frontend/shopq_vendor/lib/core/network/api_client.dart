...
class ApiClient {
  ...
  static Future<void> clearSession() async => StorageService.clear();
...
// Backward-compat alias — code referencing VendorApiHelper continues to compile.
typedef VendorApiHelper = ApiClient;
