...
import 'package:shopq_vendor/core/network/api_client.dart';
import 'package:shopq_vendor/core/network/api_endpoints.dart';
import 'package:shopq_vendor/core/storage/storage_service.dart';
import '../models/app_notification.dart';

/// Drives the vendor Notification Center: list, unread badge, read/archive.
class NotificationController extends GetxController {
  ...
  /// Swipe action — archive (removes from the active list).
