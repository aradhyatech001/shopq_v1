...
class _DeliveryAddressScreenState extends State<DeliveryAddressScreen> {
  ...
  Future<void> _loadSelectedAddress() async {
    final savedId = AppStorage.selectedAddressId;
    setState(() {
      selectedAddressId = savedId.isNotEmpty ? savedId : null;
    });
  }
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData["success"] == "true") {
          ...
          if (selectedAddressId == addressId) {
            AppStorage.selectedAddressId = '';
            AppStorage.selectedAddressFull = '';
            setState(() {
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          AppStorage.selectedAddressId = address["id"].toString();
                          AppStorage.selectedAddressFull = address["full_address"] ?? "";
                          setState(() {
