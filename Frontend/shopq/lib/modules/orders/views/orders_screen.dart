...
import 'package:shopq/modules/home/views/bottom_nav_screen.dart';
...
class _OrderScreenState extends State<OrderScreen>
  ...
  Widget _buildActiveOrderCard(Map orderMap) {
    ...
    return InkWell(
      onTap: () {
        Get.to(() => OrderSummary(orderMap: orderMap));
      },
      child: Container(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          Get.to(() => TrackOrder(status: status, orderId: orderData["id"]?.toString() ?? ""));
                        },
                        child: Container(
                          width: 120.w,
                          height: 27.h,
