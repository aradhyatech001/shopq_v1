...
class _HelpScreenState extends State<HelpScreen> {
  ...
  Future<void> fetchCallingNumber() async {
    try {
      final response = await ApiHelper.get(ApiConstants.GET_CALLING_NUMBER);
  ...
  Future<void> fetchWhatsappNumber() async {
    try {
      final response = await ApiHelper.get(ApiConstants.GET_WHATSAPP_NUMBER);
      final data = jsonDecode(response.body);
  ...
  Future<void> fetchEmail() async {
    try {
      final response = await ApiHelper.get(ApiConstants.GET_EMAIL);
      final data = jsonDecode(response.body);
