class ApiEndpoints {
  ...
  static const String ADD_SUBCATEGORY = "$BASE_URL/categories/subcategories/add";
  static const String EDIT_SUBCATEGORY = "$BASE_URL/categories/subcategories/edit";
  static const String DELETE_SUBCATEGORY = "$BASE_URL/categories/subcategories/delete";
  ...
  static const String VIEW_ALL_PRODUCTS_BY_CATEGORY = "$BASE_URL/products/by-category";
  ...
  // ── Settings ──────────────────────────────────────
  static const String FETCH_DELIVERY_AMOUNT = "$BASE_URL/settings/delivery-charge";
  static const String GET_FREE_DELIVERY_AMOUNT = "$BASE_URL/settings/free-delivery";
  static const String GET_HANDLING_CHARGE = "$BASE_URL/settings/handling-charge";
